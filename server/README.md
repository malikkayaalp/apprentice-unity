...
| `yazilabilir` | string[] | yazma izni verilen dosyaların **tam listesi**; dışına yazma reddedilir. Ölçüldü: "yalnızca X yaz" kriteri metin olarak tutmuyor — dama görevinde işçi 11 dosya yazdı |
